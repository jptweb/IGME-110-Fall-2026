...
<img src="_images/transmedia-example-comic.png" alt="Three-panel comic with no words. Panel 1: a woman walking sees a cat, with an exclamation point in her thought bubble. Panel 2: she shows a heart in a speech bubble while the cat has a question mark. Panel 3: a dump truck passes, the cat is gone, and her speech bubble shows a sad face." width="700">

**The flowchart.** One opening, two middle boxes, four endings.

<img src="_images/transmedia-example-flowchart.png" alt="Choose-your-own-adventure flowchart. The opening box: you spot a cat on a walk, keep walking or call it over. Each choice leads to a middle box with two more choices, and those lead to four different endings, from being late to class to the cat running into traffic." width="700">
